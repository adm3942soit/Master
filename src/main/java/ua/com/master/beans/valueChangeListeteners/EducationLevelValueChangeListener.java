 ...
 */
public class EducationLevelValueChangeListener implements ValueChangeListener {
    @Override
    public void processValueChange(ValueChangeEvent valueChangeEvent) throws AbortProcessingException {
        ...
        registerPersonBean.setChosenEducationLevel(valueChangeEvent.getNewValue().toString());
    }
}
