 ...
 */
public class PassportTypeValueChangeListener implements ValueChangeListener{
    @Override
    public void processValueChange(ValueChangeEvent valueChangeEvent) throws AbortProcessingException {
        ...
        registerPersonBean.setPassportType(((String) valueChangeEvent.getNewValue()).trim());
    }
}
